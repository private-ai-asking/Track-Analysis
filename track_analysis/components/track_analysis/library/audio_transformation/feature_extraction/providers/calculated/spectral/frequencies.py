...
@MEMORY.cache(identifier_arg="identifier")
def _compute_fft_frequencies(*, sample_rate: int, n_fft: int, identifier: str = "__FFT FREQUENCIES__") -> np.ndarray:
    """
...
class FFTFrequenciesProvider(AudioDataFeatureProvider):
    ...
    def provide(self, data: Dict[AudioDataFeature, Any]) -> Dict[AudioDataFeature, Any]:
        ...
        return {AudioDataFeature.FFT_FREQUENCIES: fft_freqs}
