...
class AudioCalculator:
    def __init__(self,
        ...
        calculators = [LoudnessCalculator(), RmsCalculator(), SpectralRhythmCalculator(harmonic_extractor, magnitude_extractor, onset_extractor, onset_extractor_multi, zcr_extractor, flatness_extractor, contrast_extractor, hop_length=512)]
