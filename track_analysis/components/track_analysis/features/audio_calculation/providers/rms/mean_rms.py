...
from track_analysis.components.track_analysis.features.audio_calculation.audio_data_feature import \
    AudioDataFeature
from track_analysis.components.track_analysis.features.audio_calculation.providers.helpers.rms_helper import \
    compute_short_time_rms_dbfs
from track_analysis.components.track_analysis.features.audio_calculation.audio_data_feature_provider import AudioDataFeatureProvider


class MeanRmsProvider(AudioDataFeatureProvider):
    @property
