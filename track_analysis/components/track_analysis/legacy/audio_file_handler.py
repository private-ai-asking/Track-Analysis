...
from track_analysis.components.track_analysis.library.audio_transformation.feature_extraction.providers.calculated.rhythm.tempo_provider import \
    BeatDetector
from track_analysis.components.track_analysis.shared.ffprobe_client import FFprobeClient
...
from track_analysis.components.track_analysis.shared.audio_format_converter import AudioFormatConverter
...
@deprecated("Please switch to using the feature provider ecosystem.")
