...
class SegmentationTest:
    def __init__(self, logger: HoornLogger, min_segment_level: int = 3, subdivisions_per_beat: int = 2):
        ...
        self._audio_segmenter: AudioSegmenter = AudioSegmenter(logger, subdivisions_per_beat=subdivisions_per_beat, cache_dir=EXPENSIVE_CACHE_DIRECTORY / "audio segmentation")
